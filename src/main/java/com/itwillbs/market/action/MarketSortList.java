...
public class MarketSortList implements Action{

	@Override
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		System.out.println("MarketSortList excute()");
		...
		if(!(trade_type.equals(""))) {
			if(arr.equals("Latest")) {dtolist = dao.getMenuMarketLatestList(trade_type, start, num);}
			else if(arr.equals("View")) {dtolist = dao.getMenuMarketViewList(trade_type, start, num);}
			else if(arr.equals("Att")) {dtolist = dao.getMenuMarketAttList(trade_type, start, num);}
		} else {
			if(arr.equals("Latest")) {dtolist = dao.getMarketLatestList(start, num);}
			else if(arr.equals("View")) {dtolist = dao.getMarketViewList(start, num);}
			else if(arr.equals("Att")) {dtolist = dao.getMarketAttList(start, num);}
		}
		...
		forward.setPath("market/MarketSortList.jsp");
