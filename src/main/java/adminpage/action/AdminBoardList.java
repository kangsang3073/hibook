...
public class AdminBoardList implements Action{
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		// BoardDAO 객체생성 
		// 리턴할형 ArrayList<BoardDTO> getAllBoardList() 메서드 정의 
		...
		// 메서드 호출 
		ArrayList<BoardDTO> boardList = dao.getAllBoardList(startRow, pageSize);
		...
		int count = dao.getAllBoardCount(); 
		...
		forward.setPath("adminpage/adminBoard2.jsp");
